        ...
        {isOpen && (
          ...
          >
            ...
            {voices.length > 0 && !showAnalytics && (
              <div className="px-5 py-2 bg-slate-950/20 border-b border-slate-800/40 flex items-center justify-between text-[10px] text-slate-400 flex-shrink-0 relative z-20">
